...
const i18n = {
  it: {
    ...
    hero: { eyebrow: "Mestre · Venezia", headline_a: "Modernità e relax", headline_b: "nel cuore di Mestre,", headline_c: "a un soffio da Venezia.", sub: "Comfort moderno e posizione strategica. Venezia a pochi minuti, tutto il resto a portata di passeggiata.", see_apartments: "Scopri gli appartamenti", rating_label: "su 247 recensioni" },
    ...
    amenities: {
      ...
      items: [
        ["Parcheggio in loco su richiesta", "Arrivi comodamente in auto — un privilegio raro a Venezia.", "parking", true],
        ...
        ["Check-in con accoglienza", "Indicazioni sulla città e consigli utili da chi conosce il territorio.", "key", false],
    ...
    booking: { title_a: "Pronto per la tua", title_b: "fuga veneziana?", sub: "Tutte le informazioni utili per organizzare al meglio il tuo arrivo e soggiorno.", booking_label: "Prenota su", booking_sub: "Cancellazione gratuita", airbnb_label: "Prenota su", airbnb_sub: "Superhost dal 2023", checkin_title: "Check-in & Check-out", checkin_from: "Check-in con accoglienza dalle 14:00", checkin_late: "Indicazioni sulla città e consigli utili all'arrivo", checkout: "Check-out entro le 11:00", cancel_title: "Politica di cancellazione", cancel_prepaid: "Tariffa prepagata: non rimborsabile", cancel_standard: "Tariffa standard: saldo dovuto 10 giorni prima del check-in" },
    footer: { tagline: "Cinque appartamenti moderni nel cuore di Venezia Mestre. Ristrutturati nel 2024, pensati per chi viaggia bene.", col_visit: "Visita", col_stay: "Soggiorno", col_contact: "Contatti", links_visit: ["Gli appartamenti","Dove siamo","L'esperienza","Recensioni"], links_stay: ["Check-in info","Politica cancellazione"], address: "66 Piazza XXVII Ottobre,\n30172 Mestre, Italia", phone: "+39 351 476 1333", email: "apartments@lebarche66.com", rights: "© 2026 Le Barche 66. Tutti i diritti riservati.", privacy: "Privacy", terms: "Termini" }
  },
  en: {
    nav: { apartments: "Apartments", location: "Location", experience: "Experience", reviews: "Reviews", book: "Book" },
    hero: { eyebrow: "Mestre · Venice", headline_a: "Modern comfort", headline_b: "in the heart of Mestre,", headline_c: "a breath from Venice.", sub: "Modern comfort, strategic location. Venice in minutes, everything else just steps away.", see_apartments: "View apartments", rating_label: "from 247 reviews" },
    ...
    amenities: {
      ...
      items: [
        ["On-site parking on request","Arrive easily by car — a rare privilege in Venice.","parking",true],
        ...
        ["Hosted check-in","City tips and useful local recommendations from someone who knows the area.","key",false],
    ...
    booking: { title_a: "Ready for your", title_b: "Venetian getaway?", sub: "All the key information to help you plan your arrival and stay.", booking_label: "Book on", booking_sub: "Free cancellation", airbnb_label: "Book on", airbnb_sub: "Superhost since 2023", checkin_title: "Check-in & Check-out", checkin_from: "Hosted check-in from 14:00", checkin_late: "City tips and useful local recommendations on arrival", checkout: "Check-out by 11:00", cancel_title: "Cancellation policy", cancel_prepaid: "Prepaid rate: non-refundable", cancel_standard: "Standard rate: full payment due 10 days before check-in" },
    footer: { tagline: "Five modern apartments in the heart of Venice Mestre. Renovated in 2024, designed for thoughtful travellers.", col_visit: "Visit", col_stay: "Stay", col_contact: "Contact", links_visit: ["The apartments","Location","Experience","Reviews"], links_stay: ["Check-in info","Cancellation policy"], address: "66 Piazza XXVII Ottobre,\n30172 Mestre, Italy", phone: "+39 351 476 1333", email: "apartments@lebarche66.com", rights: "© 2026 Le Barche 66. All rights reserved.", privacy: "Privacy", terms: "Terms" }
  },
  de: {
    nav: { apartments: "Apartments", location: "Lage", experience: "Erlebnis", reviews: "Bewertungen", book: "Buchen" },
    hero: { eyebrow: "Mestre · Venedig", headline_a: "Moderner Komfort", headline_b: "im Herzen von Mestre,", headline_c: "einen Atemzug von Venedig.", sub: "Moderner Komfort, strategische Lage. Venedig in Minuten, alles andere nur ein paar Schritte entfernt.", see_apartments: "Apartments ansehen", rating_label: "aus 247 Bewertungen" },
    ...
    amenities: {
      ...
      items: [
        ["Parkplatz vor Ort auf Anfrage","Bequeme Anreise mit dem Auto — in Venedig ein seltenes Privileg.","parking",true],
        ...
        ["Persönlicher Check-in","Tipps zur Stadt und hilfreiche Empfehlungen von jemandem, der die Gegend kennt.","key",false],
    ...
    booking: { title_a: "Bereit für Ihre", title_b: "venezianische Auszeit?", sub: "Alle wichtigen Informationen, um Ihre Anreise und Ihren Aufenthalt optimal zu planen.", booking_label: "Buchen auf", booking_sub: "Kostenlose Stornierung", airbnb_label: "Buchen auf", airbnb_sub: "Superhost seit 2023", checkin_title: "Check-in & Check-out", checkin_from: "Persönlicher Check-in ab 14:00 Uhr", checkin_late: "Tipps zur Stadt und nützliche Empfehlungen bei der Ankunft", checkout: "Check-out bis 11:00 Uhr", cancel_title: "Stornierungsbedingungen", cancel_prepaid: "Vorauszahlungsrate: nicht erstattungsfähig", cancel_standard: "Standardrate: vollständige Zahlung 10 Tage vor Check-in fällig" },
    footer: { tagline: "Fünf moderne Apartments im Herzen von Venedig Mestre. 2024 renoviert, gemacht für bewusste Reisende.", col_visit: "Besuchen", col_stay: "Aufenthalt", col_contact: "Kontakt", links_visit: ["Die Apartments","Lage","Erlebnis","Bewertungen"], links_stay: ["Check-in Info","Stornierungsbedingungen"], address: "66 Piazza XXVII Ottobre,\n30172 Mestre, Italien", phone: "+39 351 476 1333", email: "apartments@lebarche66.com", rights: "© 2026 Le Barche 66. Alle Rechte vorbehalten.", privacy: "Datenschutz", terms: "AGB" }
  }
} as const;
